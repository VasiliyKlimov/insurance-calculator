      ...
      <ul>
        ...
        <li><a href="#" onclick="toggleDocument('policyContent'); return false;">Образец страхового полиса</a>
          <div class="document-content" id="policyContent">
            ...
            <h4><b>1. Немедленные действия после укуса клеща</b></h4>
            <ol>
              <li><b>Осмотрите место укуса:</b>
                <ul>
                  <li>Найдите место присасывания клеща.</li>
                  <li>Не паникуйте и постарайтесь не раздавить клеща.</li>
                </ul>
              </li>
              <li><b>Аккуратное удаление клеща:</b>
                <ul>
            ...
            <h4><b>2. Обращение в медицинское учреждение</b></h4>
            <ol>
              <li><b>Сохраните извлеченного клеща:</b>
                <ul>
              ...
              <li><b>Проведение экстренной профилактики:</b>
                <ul>
            ...
            <h4><b>3. Уведомление страховой компании</b></h4>
            <ol>
              <li><b>Сообщите о страховом случае:</b>
                <ul>
            ...
            <h4><b>4. Сбор и предоставление документов</b></h4>
            <ol>
              <li><b>Обязательные документы:</b>
                <ul>
              ...
              <li><b>Дополнительные документы (если требуются):</b>
                <ul>
            ...
            <h4><b>7. Оспаривание отказа (при необходимости)</b></h4>
            <ol>
              <li><b>Запрос разъяснений:</b>
                <ul>
                  <li>В случае отказа запросите письменное обоснование.</li>
                </ul>
              </li>
              <li><b>Обращение в надзорные органы:</b>
                <ul>
                  <li>В случае нарушения прав обратитесь в Роспотребнадзор или Центральный банк РФ.</li>
                </ul>
              </li>
              <li><b>Юридическое разбирательство:</b>
                <ul>
